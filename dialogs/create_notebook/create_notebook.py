...
import dialogs.create_notebook.create_notebook_viewgtk as create_notebook_viewgtk

import os.path


class CreateNotebookDialog(Dialog):
    ...
    def setup(self):
        self.view = create_notebook_viewgtk.CreateNotebook(self.main_window)

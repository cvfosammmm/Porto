...
class WelcomePageView(Gtk.ScrolledWindow):
    ...
    def __init__(self):
        ...
        self.create_link = Gtk.LinkButton('action://win.placeholder', 'Create New Notebook')
        self.create_link.set_action_name('win.create')
        self.create_link.set_can_focus(False)
        self.create_link.set_tooltip_text('')
        self.open_link = Gtk.LinkButton('action://win.placeholder', 'Open Notebook(s)')
        self.open_link.set_action_name('win.open')
        self.open_link.set_can_focus(False)
        self.open_link.set_tooltip_text('')
        self.welcome_links.pack_start(self.create_link, False, False, 0)
        self.welcome_links.pack_start(Gtk.Label(' or '), False, False, 0)
        self.welcome_links.pack_start(self.open_link, False, False, 0)

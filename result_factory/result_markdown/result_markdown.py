...
h1 { font-size: 36px; line-height: 40px; font-weight: bold; margin-top: 20px; margin-bottom: 20px; font-family: Cantarell Ultra-Bold, cantarell; font-weight: 800; text-align: left; }
h2 { font-size: 24px; line-height: 30px; font-weight: bold; margin-top: 20px; margin-bottom: 20px; }
h3 { font-size: 20px; font-weight: bold; margin-top: 20px; margin-bottom: 20px; line-height: 100% }

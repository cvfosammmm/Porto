...
class HeaderbarControlsPresenter(object):
    ...
    def __init__(self, worksheet, button_box, save_button, title):
    ...
    def update_title(self):
        ...
        self.title.title_label.set_text(save_state + self.worksheet.get_name())
    ...
    def update_save_button(self):
        if self.worksheet.get_save_state() == 'modified':

...
class NotebookListRecentView(Gtk.ListBox):
...
class NotebookListViewItem(Gtk.ListBoxRow):
...
class RecentNotebookListViewItem(NotebookListViewItem):
    ''' Link in sidebar to activate notebook, show some data about it '''
    
    def __init__(self, pathname, kernelname, last_saved):
        NotebookListViewItem.__init__(self, pathname, kernelname, last_saved)
        ...
        self.set_name(helpers.get_notebook_name_from_pathname(pathname))
